...
challenge:
  ...
  text2: 'Utmaning: Samla ihop 39 km längdskidåkning på ett dygn, välj mellan klassisk stil eller fristil.<br><br>Rekommenderad tur: Start utgår från Ramundberget, kör Klinken runt, följ 4Motion-spåret till Bruksvallarna, vänd sedan tillbaka till Ramundberget via 4Motion, i Ramundberget fortsätt därefter Klinken runt en sista gång.'
...
goal:
  ...
  text: '' 
  image: Ramisklassikern_karta-langd.png
  imagealt: Karta
  warningmap: 
